...
## Version History
 * 2024-02-15 v1.3.6:  Bump SMDA to address issue with `nesting_depth` in SmdaFunction, fixed exception prints in IDA plugin's McritInterface (THX to @malwarefrank!!).
